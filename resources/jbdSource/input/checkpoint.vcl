...
int ?@jbd2Prefix?log_do_checkpoint(journal_t *journal)
{
	...
	trace_?@folderName?_checkpoint(journal, result);
...
#select folderName
	...
	trace_?@folderName?_drop_transaction(journal, transaction);
