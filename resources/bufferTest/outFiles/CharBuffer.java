...

{
     ...
     *
     * <p> The new buffer will be backed by the the given char array;
     ...
     * write was incomplete.  The following loop, for example, copies chars
     ...
     *         break;        // No more chars to transfer
     *     buf.flip();
     *     out.write(buf);
