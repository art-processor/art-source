...
#set author = "Rick Koch <n1gp@hotmail.com>", "Claudio Nieder <private@claudio.ch>", "Rick Koch <n1gp@hotmail.com>", "Richard Lemon <richard@codelemon.com>", "Dmitry Torokhov <dtor@mail.ru>", "Adam Bennett <abennett72@mail.com>", "Tias Guns <tias@ulyssis.org>", "Vojtech Pavlik <vojtech@ucw.cz>", "Vojtech Pavlik <vojtech@ucw.cz>"
...
#while driverName, length, description, author, protocolName, drvLongName, serioDrivename, vendor, product, serioProto, version, setAbsParam1, setAbsParam2, setAbsParam3, setAbsParam4, setAbsParam5
	...
	#output "resources/linuxExample/touchscreenDrivers/output/"?@driverName?"_generated.c"
	#adapt "resources/linuxExample/touchscreenDrivers/common.vcl"
